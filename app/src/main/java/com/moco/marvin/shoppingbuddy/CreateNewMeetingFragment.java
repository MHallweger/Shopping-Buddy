 ...
 */
public class CreateNewMeetingFragment extends Fragment implements View.OnClickListener{
    ...
    public CreateNewMeetingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.create_meeting_middle_end_part, container, false);
        ...
        modeField = view.findViewById(R.id.modusID);
        personsField = view.findViewById(R.id.personenanzahlID);
        whereField = view.findViewById(R.id.woID);
        genderField = view.findViewById(R.id.geschlechtID);
        whatField = view.findViewById(R.id.wasID);
        kindField = view.findViewById(R.id.artID);
        whenField = view.findViewById(R.id.wannID);
        descriptionField = view.findViewById(R.id.beschreibungID);
        locationField = view.findViewById(R.id.locationID);

        addPhoto = view.findViewById(R.id.addPhotoID);

        newMeeting = view.findViewById(R.id.buttonCreateNewMeeting);
